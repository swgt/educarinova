# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-04-14 23:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('month', models.PositiveIntegerField(choices=[(1, 'Janeiro'), (2, 'Fevereiro'), (3, 'Março'), (4, 'Abril'), (5, 'Maio'), (6, 'Junho'), (7, 'Julho'), (8, 'Agosto'), (9, 'Setembro'), (10, 'Outubro'), (11, 'Novembro'), (12, 'Dezembro')], verbose_name='mês de cotratação')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shift', models.CharField(choices=[('Matutino', 'Matutino'), ('Vespertino', 'Vespertino'), ('Noturno', 'Noturno'), ('Outro', 'Outro')], max_length=10, verbose_name='turno')),
                ('period', models.CharField(choices=[('Meio Periodo', 'Meio Periodo'), ('Integral', 'Integral')], max_length=12, verbose_name='período')),
                ('value_tuition_fee', models.DecimalField(decimal_places=2, default=0.0, max_digits=5, verbose_name='mensalidade base (R$)')),
            ],
        ),
        migrations.CreateModel(
            name='Classroom',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Ativo', 'Ativo'), ('Desativado', 'Desativado'), ('Em Análise', 'Em Análise'), ('Em Curso', 'Em Curso'), ('Concluido', 'Concluido')], max_length=10, null=True, verbose_name='situação')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matriculation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='management.Matriculation', verbose_name='matricula')),
            ],
        ),
        migrations.CreateModel(
            name='ReportCard',
        ...
        migrations.AddField(
            model_name='matriculation',
            name='school_class',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='management.Class', verbose_name='turma'),
        ),
        migrations.AddField(
            model_name='matriculation',
            name='tuition_fee',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='management.TuitionFee', verbose_name='mensalidade'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='matriculation',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='management.Student', verbose_name='aluno'),
        ),
    ]
